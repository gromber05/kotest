...
class UsuarioService(
    ...
    override fun obtenerTareasPorUsuario(usuario: Usuario): List<Tarea> = usuario.obtenerTareasAsignadas()

    override fun obtenerUsuarioPorNombre(nombre: String): Usuario? = repositorio.obtenerUsuarioPorNombre(nombre)
}
